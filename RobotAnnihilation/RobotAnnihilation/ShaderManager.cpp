...
{
	bool result;
	result = myAnimatedShader->Render(myContext, indicies, world, view, projection, texture, normalTexture, lightDir, dirColor, binds, myPos, myCol, spotCol, spotDir, spotPos, spotEx, cam, specCol, specEx, red, bomb, frozen);
	if (!result)
	{
		return false;
	}
